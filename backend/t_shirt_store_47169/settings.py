"""
Django settings for t_shirt_store_47169 project.
...
ROOT_URLCONF = 't_shirt_store_47169.urls'
...
WSGI_APPLICATION = 't_shirt_store_47169.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "t_shirt_store_47169 API",
    "DESCRIPTION": "API documentation for t_shirt_store_47169 App",
    "VERSION": "v1",
}
